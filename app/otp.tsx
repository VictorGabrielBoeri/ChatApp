    ...
    <KeyboardAvoidingView
      ...
      {loading && (
        <View style={[StyleSheet.absoluteFill, styles.loading]}>
          ...
          <Text style={{ fontSize: 18, padding: 10 }}>Enviando seu código...</Text>
        </View>
      )}

      <View style={styles.container}>
        <Text style={styles.description}>
          O WhatsApp precisará verificar sua conta. Taxas de transporte podem ser aplicadas.
        </Text>

        <View style={styles.list}>
          <View style={styles.listItem}>
            <Text style={styles.listItemText}>Brasil</Text>
          ...
          <MaskInput
            ...
            autoFocus
            placeholder="+55 Digite seu número aqui"
        ...
        <Text style={styles.legal}>
          ...
          para se registrar. Saiba como o WhatsApp funciona com as{' '}
          <Text style={styles.link} onPress={openLink}>
            Meta Companies
          </Text>
          .
