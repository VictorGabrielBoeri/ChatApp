...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modals)/new-chat` | `/new-chat` | `/(tabs)/calls/` | `/calls/` | `/(tabs)/calls` | `/(tabs)/chats/` | `/chats/` | `/(tabs)/chats` | `/(tabs)/communities` | `/communities` | `/(tabs)/settings/` | `/settings/` | `/(tabs)/settings` | `/(tabs)/updates` | `/updates` | `/otp`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/(tabs)/chats/${SingleRoutePart<T>}` | `/chats/${SingleRoutePart<T>}` | `/verify/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/(tabs)/chats/[id]` | `/verify/[phone]`;
